...
export type DuplicateStrictnessLevel =
  | "very_relaxed"
  | "relaxed"
  | "balanced"
  | "strict";
...
export const DUPLICATE_STRICTNESS_OPTIONS: DuplicateStrictnessOption[] = [
  {
    ...
    label: "Extrem Locker",
    description:
      'Findet auch entfernte Ähnlichkeiten (z.B. "Herr Frank" & "Siegfried Frank")',
    params: {
      name_match: "contains",
...
export const DEFAULT_DUPLICATE_STRICTNESS: DuplicateStrictnessLevel =
  "balanced";
