  ...
  const onSubmit = async (values: LoginSchema) => {
    ...
    try {
      ...
      const message =
        ...
        "Die Anmeldung ist fehlgeschlagen. Bitte überprüfe E-Mail und Passwort " +
        "oder versuche es in wenigen Sekunden erneut.";
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-slate-500">
          Mindestens 8 Zeichen – für optimale Sicherheit empfehlen wir 12+
          Zeichen.
        </p>
      </div>
      ...
      <div className="flex items-center justify-between">
        <label className="inline-flex items-center gap-2 text-xs text-slate-600">
          <input
            type="checkbox"
            className={[
              "h-4 w-4 rounded border border-slate-300 bg-white text-brand-500",
      ...
      <p className="text-center text-xs text-slate-500">
        Probleme bei der Anmeldung? Kontaktiere dein EmmaTresor-Team.
      </p>
    </form>
  );
};
