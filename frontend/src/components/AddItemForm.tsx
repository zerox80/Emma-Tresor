...
const AddItemForm: React.FC<AddItemFormProps> = ({ locations, tags, onSuccess, onCancel }) => {
  ...
  return (
    <form
      className="mx-auto w-full max-w-2xl space-y-5 text-slate-700"
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm space-y-5">
        <div className="space-y-3">
          ...
          <input
            id="name"
            type="text"
            className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-slate-800 shadow-sm transition focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-200/60"
